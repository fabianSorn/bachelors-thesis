...
Matplotlibs central item is the \inlinecode{Python}{matplotlib.figure.Figure}.
The Figure itself does not yet display anything, neither a plot with axes nor
data. A plot is reffered as an \inlinecode{Python}{matplotlib.axes.Axes}. A
...
\inlinecode{Python}{pyqtgraph.PlotWidget}. Since it is derived from
\inlinecode{Python}{QtWidgets.QWidget}, it is very simple to add to a window.
...
\inlinecode{Python}{pyqtgraph.ViewBox}, which is the area data is visualized in,
a \inlinecode{Python}{pyqtgraph.AxisItem}, which is representing the View Range
...
representations like a \inlinecode{Python}{pyqtgraph.PlotDataItem} for Scatter
Plots and Line Graphs or \inlinecode{Python}{pyqtgraph.BarGraphItem} for
...
we can use \inlinecode{Python}{pyqtgraph.PlotDataItem}. For the Bar Graph we
create a \inlinecode{Python}{pyqtgraph.BarGraphItem}. Each item can then be
...
One feature which PyQtGraph is lacking, is the ability to plot two ore more
...
areas, which are \inlinecode{Python}{pyqtgraph.ViewBox}. The shown view range is
displayed by an \inlinecode{Python}{pyqtgraph.AxisItem}. In the extension a
...
The other addition made to PyQtGraph is a convenience layer on top of different
...
Both, pure PyQtGraph as well as the extended versions will be included in our
...
%% Source Chapter 5.5 of Jacob Nielsen's Usablility Engineering (https://www.nngroup.com/books/usability-engineering/)
...
Especially in the area of computer games, high Framerates are desirable, since
...
%% Source: https://aframe.com/blog/2013/07/a-beginners-guide-to-frame-rates/
%% Source: https://en.wikipedia.org/wiki/Frame_rate
%% Source: https://medium.com/@dr3wc/understanding-delta-time-b53bf4781a03
...
%% Source: https://julien.danjou.info/guide-to-python-profiling-cprofile-concrete-case-carbonara/
...
%% Source: https://docs.python.org/3.8/library/profile.html
...
\inlinecode{Python}{MatplotlibCode} can implement the functionality defined by
...
\inlinecode{Python}{abstractmethod} decorator provided by the abc package.
...
%% Source: https://doc.qt.io/qt-5/qtimer.html#details
...
\inlinecode{Python}{setuptools}, we can register wrap register our CLI as an
